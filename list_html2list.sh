...
mv index_all.html /tmp/index_all.html$$
mv index_search.html /tmp/index_search.html$$

./list_recenthtml.sh > /tmp/latest$$

./insert_into_template.pl index.tml /tmp/out$$ INDEX.TMPL > index.html
...
./insert_into_template.pl index_all.tml /tmp/out$$ INDEX.TMPL > index_all.html
